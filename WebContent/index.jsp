...
<div class="Mt20" style="width: 300px; margin-left: auto; margin-right: auto; border: solid #000 1px; padding: 20px;">
	<form action="/login" method="POST">
		<table>
			<tr>
				<td><label for="user">用户名：</label></td>
				<td><input type="text" id="user" name="user" /></td>
				<td><input type="submit" name="login" value="登陆" style="width: 80px;" /></td>
			</tr>
			<tr>
		   		<td><label for="pswd">密&nbsp&nbsp&nbsp码：</label></td>
		   		<td><input type="password" id="pswd" name="pswd" /></td>
		   		<td><input type="submit" name="admin" value="管理员登陆" style="width: 80px;" /></td>
		   	</tr>
		</table>
