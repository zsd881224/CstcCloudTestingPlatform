function info_check() {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/info_check",true);
		xmlhttp.send(null);
	}
	else {
...
function loadTestTemplate() {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/listTestTemplate",true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function updateTemplateList(xmlhttp) {
	if (xmlhttp.readyState==4) {// 4 = "loaded"
		if (xmlhttp.status==200) {// 200 = "OK"
			document.getElementById('listTestTemplate').innerHTML=xmlhttp.responseText;
			loadBasicInfo();
		}
	}
}
...
function loadBasicInfo() {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/getBasicInfo",true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function loadDevicesInfo() {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/listApp",true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function releaseResource(vappname) {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/releaseResource?vapp="+vappname,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function showNetworkSetting(vappname) {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/getNetworkInfo?vapp="+vappname,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function changeState(vmid, newstate) {
	...
	if (xmlhttp!=null) {
		xmlhttp.onreadystatechange=function() {updateNetworkInfo(xmlhttp);};
		xmlhttp.open("POST","/performanceTesting/changeState?vmid="+vmid+"&newstate="+newstate,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function showRunState(obj) {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/getRunState?vmid="+obj,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function createVapp(templateName,vappName) {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/createVapp?templatename="+templateName+"&name="+vappName,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
...
function showConsole(vmId) {
	...
	if (xmlhttp!=null) {
		...
		xmlhttp.open("POST","/performanceTesting/showConsole?vmid="+vmId,true);
		xmlhttp.send(null);
	}
	else {
		alert("Your browser does not support XMLHTTP.");
